...
And we want to stress that consistency is a factor of quality, not the other way around.  Sometimes, consistency takes a back seat to the other qualities, and that's ok. 
